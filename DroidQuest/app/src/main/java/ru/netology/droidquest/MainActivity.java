...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deceitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deceitUsed[currentIndex] = true; // Установка флага, что кнопка "Обмануть" была использована для текущего вопроса
                deceitQuestions.add(currentIndex); // Добавление индекса текущего вопроса в список
    ...
    private void checkAnswer(boolean userAnswer) {
        ...
        userAnswers[currentIndex] = userAnswer; // Сохранение ответа пользователя
